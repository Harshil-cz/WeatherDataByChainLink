...
contract AccuweatherConsumer is ChainlinkClient {
    ...
    bytes32 public requestIdForLocation;
    bytes32 public requestIdForCurrentConditions;
    // By requestIdForLocationCurrentConditions we can get data of both
    // requestIdLocationResult and requestIdCurrentConditionsResult.
    bytes32 public requestIdForLocationCurrentConditions; 
    ...
    function requestLocation(
        ...
        requestIdForLocation=requestId;
    ...
    function requestCurrentConditions(
        ...
        bytes32 requestId = sendChainlinkRequest(req, _payment);
        requestIdForCurrentConditions=requestId;
        // Below this line is just an example of usage
    ...
    function requestLocationCurrentConditions(
        ...
        req.add("units", _units);
        bytes32 requestId = sendChainlinkRequest(req, _payment);
        requestIdForLocationCurrentConditions=requestId;
        // Below this line is just an example of usage
...
// For Reference : https://market.link/nodes/AccuWeather/integrations#LocationResult